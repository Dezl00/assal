  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <SidePanel 
        ...
        description="قم بإدخال بيانات المنتج، المخزون والأسعار."
        width="lg"
      >
        <form action={handleCreate} className="space-y-6 pb-20">
          <div className="space-y-6">
            <h2 className="text-lg font-semibold tracking-tight border-b border-border/50 pb-2">المعلومات الأساسية</h2>
            ...
            <h2 className="text-lg font-semibold tracking-tight border-b border-border/50 pb-2 pt-4">التنظيم والتصنيف</h2>
            ...
            <h2 className="text-lg font-semibold tracking-tight border-b border-border/50 pb-2 pt-4">التسعير والمخزون</h2>
          ...
          <div className="fixed bottom-0 left-0 right-0 p-4 border-t border-border/50 bg-background flex gap-3 shadow-[0_-10px_15px_-3px_rgba(0,0,0,0.05)] md:absolute">
             <Button type="submit" disabled={isSubmitting} className="flex-1 h-12 text-base">
               {isSubmitting ? "جاري الحفظ..." : "حفظ المنتج"}
             </Button>
             <Button type="button" variant="outline" className="h-12 w-24 text-base" onClick={() => setIsPanelOpen(false)}>
               إلغاء
             </Button>
          </div>
        </form>
